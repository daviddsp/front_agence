...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	__webpack_require__(478).polyfill();
	...
	var loadConsultors = exports.loadConsultors = function loadConsultors() {
	    return function (dispatch) {
	        ...
	        var request = new Request('http://localhost:8000/api/v1/consultores', { method: 'GET', mode: 'no-cors', credentials: 'include', headers: { 'Content-Type': 'application/json' } });
	        (0, _isomorphicFetch2.default)(request).then(function (resp) {
	            return resp.json();
	        }).then(function (s) {
	            console.log(s);
	        }).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function attemptVertx() {
	  try {
	    var r = require;
	    var vertx = __webpack_require__(479);
