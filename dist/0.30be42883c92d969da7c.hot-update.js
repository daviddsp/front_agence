	...
	var ButtonBox = function (_Component) {
	    ...
	    _createClass(ButtonBox, [{
	        ...
	        value: function _goTo() {
	            _reactRouter.browserHistory.push('/consultores/2007-01-31/2007-02-31/anapaula.chiodaro, carlos.arruda');
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _reactMdl.Button,
	                        { raised: true, ripple: true, colored: true, onClick: this._goTo },
	                        'Relatorio'
	                    ),
