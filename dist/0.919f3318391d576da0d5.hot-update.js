...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        ...
	        loadConsultors: function (_loadConsultors) {
	            function loadConsultors() {
	                return _loadConsultors.apply(this, arguments);
	            }

	            loadConsultors.toString = function () {
	                return _loadConsultors.toString();
	            };

	            return loadConsultors;
	        }(function () {
