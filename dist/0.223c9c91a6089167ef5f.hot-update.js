	...
	var Consultores = function (_Component) {
	    ...
	    _createClass(Consultores, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            setTimeout(function () {
	                _this2.setState({
	                    consultors: ['Abraham', 'Johuder', 'Pepe', 'Juan']
	                });
	            }, 3000);
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var _state = this.state,
	                consultorSelected = _state.consultorSelected,
	                consultors = _state.consultors;


	            if (!consultors.length) {
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    consultors.map(function (consultor, index) {
	                                        return _react2.default.createElement(
	                                            'option',
	                                            { key: 'consultar-' + index },
	                                            consultor
