...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadConsultors = exports.loadConsultors = function loadConsultors() {
	    return function (dispatch) {
	        ...
	        var request = new Request('http://localhost:8000/api/v1/consultores', { method: 'GET', mode: 'cors', credentials: 'false', headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' } });
